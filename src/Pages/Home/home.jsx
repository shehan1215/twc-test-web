    ...
    <div>
      ...
      <div class="h-screen w-full bg-[url('src/assets/Ellipse2.png')] absolute -z-9 bg-no-repeat bg-cover bg-center">
        <div class="ml-[10%] mt-[5%]">
          ...
          <h1 class="font-primaryBold text-[3rem] text-[#FFFFFF] mt-[5%]">Welcome,</h1>
          <p class='font-primaryMedium text-[1.5rem] text-[#FFFFFF]'>This is where your contacts will live. Click the button below <br /> to add a new contact.</p>
